        ...
        return (
            <div className="tc bg-light-gray dib br3 pa3 ma2 grow bw1 shadow-5 ba b--black">
                ...
                <div>
                    ...
                    <p>{position}</p>
                    <div className="tc">
                        <a href={instagram} target="_blank" className="pr1 red"><FontAwesomeIcon icon={faInstagram}></FontAwesomeIcon></a>
                        <a href={twitter} target="_blank" className="pl1 red"><FontAwesomeIcon icon={faTwitter}></FontAwesomeIcon></a>
                    </div>
                </div>
            </div>
        );
